    ...
    loading ? (
      ...
      <div className="login">
        ...
        <div className="login-form">
          ...
          <form>
            {signState === "Sign Up" && (
              <input value={name} onChange={(e) => setName(e.target.value)} type="text" placeholder="Username" className="input-field" />
            )}
          ...
          <div className="form-switch">
            {signState === "Sign In" ? (
              <p>New user? <span onClick={() => setSignState("Sign Up")}>Sign Up Now</span></p>
            ) : (
